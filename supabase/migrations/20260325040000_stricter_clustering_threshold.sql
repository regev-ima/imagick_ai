-- Lower clustering threshold from 0.6 to 0.45
-- 0.6 still groups different people together, especially when small faces
-- in group photos produce unreliable descriptors with low L2 distances.
