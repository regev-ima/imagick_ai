-- ============================================================
-- COMPREHENSIVE FIX for face search feature
-- Fixes: vector index, RLS policies, clustering threshold
-- ============================================================
...
BEGIN
  ...
  LOOP
    ...
    -- Compare against existing cluster representatives using L2 distance
    FOR v_rep IN
  ...
  -- Recalculate face_count as unique images per cluster
